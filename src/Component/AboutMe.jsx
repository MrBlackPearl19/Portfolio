        ...
        <div className="Left-part flex flex-col lg:w-2/4  items-center">
          <div className="My-detail w-4/4  p-2 my-2">
            ...
            <p className="text-white ms-24 my-2 text-2xl">
              I'M Rohan,a passionate web developer with a knack for turning
              ideas into captivating online experiences. 
              Also with ofline experience of fullstack Class.
            </p>
            <div className='border-2 border-white w-96 flex justify-between ms-24 my-4 p-2'>
                 <p className='text-white text-xl'>Name</p><p className='text-white text-xl'>:</p><p className='text-white text-xl'> Rohan  P </p>
            </div>

            <div className='border-2 border-white w-96 flex justify-between ms-24 my-4 p-2'>
                 <p className='text-white text-xl'>Email</p><p className='text-white text-xl'>:</p><p className='text-white text-xl'>mrblackpearl897111@gmail.com</p>
            </div>

            <div className='border-2 border-white w-96 flex justify-between ms-24 my-4 p-2'>
                 <p className='text-white text-xl'>Phone no.</p><p className='text-white text-xl'>:</p><p className='text-white text-xl'>8971116593</p>
            </div>
          </div>
        </div>
