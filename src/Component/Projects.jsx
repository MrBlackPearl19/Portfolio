      ...
      <div className="w-full Projects p-5 my-3 flex gap-28 justify-center flex-wrap">
        ...
        >
          ...
          <div className="Project-Detail flex flex-col items-center">
            ...
            <button className="bg-red-400 w-36 h-10 my-4 font-bold">
              <a
                href="https://github.com/MrBlackPearl19/E-commerce-"
        ...
        >
          ...
          <div className="Project-Detail flex flex-col items-center">
            ...
            <button className="bg-red-400 w-36 h-10 my-4 font-bold">
              <a
                href="https://github.com/MrBlackPearl19/ReactFirst-Project"
                className="hover:text-black"
              >
                View on Github
              </a>
        ...
        >
          ...
          <div className="Project-Detail flex flex-col items-center">
            ...
            <button className="bg-red-400 w-36 h-10 my-4 font-bold">
              <a
                href="https://github.com/MrBlackPearl19/Food-Websitet"
                className="hover:text-black"
              >
                View on Github
              </a>
